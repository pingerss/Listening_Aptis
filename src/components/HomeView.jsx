    ...
    return (
        <div className="flex flex-col gap-24">
            ...
            <section className="text-center space-y-12 max-w-5xl mx-auto py-10 relative">
                <div className="inline-flex items-center gap-3 px-6 py-2 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 font-bold mb-6">
                ...
                <div className="space-y-6">
                    <h2 className="text-7xl md:text-8xl font-black tracking-tight leading-[1.05]">
                        BECOME AN <br />
                        <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 uppercase">
                            APTIS PRO
                        </span>
                    </h2>
                    <p className="text-slate-400 text-2xl font-semibold max-w-3xl mx-auto leading-relaxed">
              ...
              `}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {tests.map((test) => (
                        ...
                        >
                            <div className="absolute inset-0 bg-gradient-to-br from-indigo-600/20 to-purple-600/20 rounded-[2.5rem] blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 hidden md:block" />
                            <div className="relative h-full bg-slate-900/40 border border-white/10 p-1 rounded-[2.5rem] transition-all group-hover:border-indigo-500/50 overflow-hidden flex flex-col">
                                <div className="bg-slate-950/40 rounded-[2.3rem] p-8 h-full flex flex-col gap-10">
                                    <div className="flex justify-between items-start">
                                        <div className="w-16 h-16 rounded-2xl bg-indigo-500/10 flex items-center justify-center border border-indigo-500/20 group-hover:bg-indigo-500 transition-all duration-500">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {updateModules.map((mod) => (
                        <div
                            ...
                            className="group relative"
                        >
                            <div className="absolute inset-0 bg-gradient-to-br from-amber-600/20 to-orange-600/20 rounded-[2.5rem] blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 hidden md:block" />
                            <div className="relative h-full bg-slate-900/40 border border-amber-500/20 p-1 rounded-[2.5rem] transition-all group-hover:border-amber-500/50 overflow-hidden flex flex-col">
                                <div className="bg-slate-950/40 rounded-[2.3rem] p-8 h-full flex flex-col gap-8">
                                    <div className="flex justify-between items-start">
                                        <div className="w-16 h-16 rounded-2xl bg-amber-500/10 flex items-center justify-center border border-amber-500/20 group-hover:bg-amber-500 transition-all duration-500">
