...
const Layout = ({ children }) => {
    return (
        <div className="min-h-screen bg-slate-950 text-slate-50 selection:bg-indigo-500/30 overflow-x-clip font-sans">
            ...
            <header className="sticky top-0 z-50 backdrop-blur-md md:backdrop-blur-2xl bg-slate-950/80 border-b border-white/10">
                <div className="max-w-7xl mx-auto px-6 h-24 flex items-center justify-between">
                    <div
                        className="flex items-center gap-4 cursor-pointer group"
                        onClick={() => window.location.reload()}
                    >
                        <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center shadow-2xl shadow-indigo-500/40">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs uppercase tracking-[0.3em] font-bold text-indigo-400">Mastery Center</span>
                        </div>
                    </div>
            ...
            <footer className="py-16 border-t border-white/10 bg-slate-950/40 relative z-10">
